...
Als gutes Vorbild kann das VINN:Lab an der TH Wildau betrachtet werden. In den letzten Jahren bestand ein guter Kontakt zu weiteren bestehenden und entstehenden FabLabs innerhalb von Hochschulen (z.B. Wildau, TU Berlin, Siegen, Aachen, Dresden, ...), so dass dort gesammelte und bei verschiedenen Treffen\footnote{Besonders die seit 2017 jährlich stattfindende Fab:Universe Konferenz war regelmäßig eine hervorragende Gelegenheit zur Vernetzung mit anderen FabLabs innerhalb der Hochschulen.} gebündelte Erfahrungen im Aufbau berücksichtigt werden können.
...
Die Arbeitssicherheit der Maschinen muss auf dem aktuellen Stand der Technik hergestellt werden - das ergibt sich schon aus der Verkehrssicherungspflicht (§§ 823 ff. BGB) gegenüber den Nutzern, den der Betrieb des FabLab mit sich bringt.
...
Seit September 2020 wird ein gemischtes Team aus Studierenden der TU Berlin sowie der Beuth Hochschule für Technik durch den Protoype-Fund in dessen 8. Runde gefördert und arbeitet intensiv an der Fertigstellung des Systems. Die Förderung läuft bis Februar 2021.
